---
---
# Annotated Bibliography — Dungeon Raiders
...
**Relation to my app:** Development framework that will be used to create *Dungeon Raiders*.
...
The main difference between these existing products and *Dungeon Raiders* is that the project combines **the custom hardware and the game into one design**. The controllers are not simply an alternative way to play an existing game. They will be designed specifically around the game's characters, abilities, and cooperative mechanics. The final goal is to demonstrate how custom physical interfaces can make two-player cooperation a more meaningful part of the gameplay experience.
